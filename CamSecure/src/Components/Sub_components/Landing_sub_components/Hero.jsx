...
export default function Hero() {
  ...
  return (
    <section 
      className="relative bg-surface overflow-hidden border-b border-outline-variant py-24 md:py-32 min-h-[70vh] flex items-center bg-cover bg-center bg-no-repeat pt-[120px]"
